    ...
    internal sealed class SwatchControl : Control
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            for (int i = 0; i < this.colors.Count; ++i)
            {
                ...
                DrawColorRectangle(e.Graphics, swatchRect, c.ToColor(), drawOutline);
            }
        ...
        private static void DrawColorRectangle(Graphics g, Rectangle rect, Color color, bool drawBorder)
        {
